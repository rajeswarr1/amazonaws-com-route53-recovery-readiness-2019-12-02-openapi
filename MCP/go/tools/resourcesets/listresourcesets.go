...
func ListresourcesetsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/resourcesets%s", cfg.BaseURL, queryString)
		...
		var result models.ListResourceSetsResponse
...
func CreateListresourcesetsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_resourcesets",
		mcp.WithDescription("Lists the resource sets in an account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListresourcesetsHandler(cfg),
	}
}
