...
func ListcellsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/cells%s", cfg.BaseURL, queryString)
		...
		var result models.ListCellsResponse
...
func CreateListcellsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_cells",
		mcp.WithDescription("Lists the cells for an account."),
