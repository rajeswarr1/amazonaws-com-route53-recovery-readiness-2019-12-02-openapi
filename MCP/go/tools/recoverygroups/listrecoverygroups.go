...
func ListrecoverygroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/recoverygroups%s", cfg.BaseURL, queryString)
		...
		var result models.ListRecoveryGroupsResponse
...
func CreateListrecoverygroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_recoverygroups",
		mcp.WithDescription("Lists the recovery groups in an account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListrecoverygroupsHandler(cfg),
	}
}
