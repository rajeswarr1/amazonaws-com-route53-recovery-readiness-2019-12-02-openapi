...
func GetreadinesscheckHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetReadinessCheckResponse
...
func CreateGetreadinesscheckTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_readinesschecks_readinessCheckName",
		mcp.WithDescription("Gets details about a readiness check."),
		mcp.WithString("readinessCheckName", mcp.Required(), mcp.Description("Name of a readiness check.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetreadinesscheckHandler(cfg),
	}
}
