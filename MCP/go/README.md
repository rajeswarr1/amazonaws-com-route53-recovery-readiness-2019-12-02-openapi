# AWS Route53 Recovery Readiness MCP Server

This MCP (Model Content Protocol) server provides access to AWS Route53 Recovery Readiness API functionality through HTTP, HTTPS, and STDIO transport modes.
